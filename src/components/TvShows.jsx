...
const TvShows = ({ query, dQuery }) => {
  ...
  const searchMovies = async () => {
    try {
      if (query.length > 3) {
        const response = await fetch(`${url}/media/=${query}`);
                        ...
                        <div class="d-flex align-items-center mb-3">
                          ...
                          <div class="circul-btn ml-2">
                            <svg
                              ...
                              height="16"
                              fill="currentColor"
                              className="bi bi-hand-thumbs-up mr-1  pl-1"
                              viewBox="0 0 16 16"
                            >
                          ...
                          <div class="circul-btn ml-2">
                            <svg
                              ...
                              height="16"
                              fill="currentColor"
                              className="bi bi-hand-thumbs-down mr-1 pl-1"
                              viewBox="0 0 16 16"
                            >
